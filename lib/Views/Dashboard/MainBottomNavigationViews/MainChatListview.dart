...
class MainChatViewDesign extends StatefulWidget {
  MainChatViewDesign() : super();

  @override
  MainChatViewDesignState createState() => MainChatViewDesignState();
}

class MainChatViewDesignState extends State<MainChatViewDesign>  {
